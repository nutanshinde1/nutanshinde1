...
- 🧠 **100+ DSA Problems** solved on LeetCode & HackerRank
...
|---------|-----------|-------------|
| 🎓 **Smart Attendance System** | React, Node.js, MongoDB | Role-based web attendance system with analytics |
| 🛒 **E-Commerce Dashboard** | React, Spring Boot, MySQL | Admin dashboard for managing products and orders |
| 🏥 **Hospital Management System** | Java, Spring Boot, SQL | Patient, doctor and appointment management |
| 🚗 **IoT Vehicle Tracking** | ESP32, Cloud | Real-time vehicle tracking dashboard |
| 📝 **Online Examination System** | React, Firebase | Secure exam platform with auto evaluation |
...
*⭐ Found something useful? Star my repos — it motivates me to keep building!*
